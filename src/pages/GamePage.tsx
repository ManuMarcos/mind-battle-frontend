...
export const GamePage = ({ question }: GamePageProps) => {
  ...
  const handleOnNextQuestion = async () => {
    try {
      const jwtToken =
        "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI2ODRjOGUyNTA3Y2NlYWJiOWEwZmI1ZWQiLCJpYXQiOjE3NTIyODU0OTcsImV4cCI6MTc1MjI5OTg5N30.IHyxg5K5veoBl0LRqFmtCQoc8O9m1NjU2MIGrc6Udds";
